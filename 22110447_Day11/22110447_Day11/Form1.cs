...
namespace _22110447_Day11 {
    public partial class Form1 : Form {
        ...
        string connectionString = @"Data Source=DELL\TANTRUSQL;Initial Catalog=qlyNhanVien;Integrated Security=True";
        ...
        private void dtgvInfomation_CellContentClick(object sender, DataGridViewCellEventArgs e) {
            if(e.RowIndex >= 0) {
