...
namespace _22110447_Day11_LINQ_Queries_with_Methods {
    internal class Program {
        ...
        public static List<Employees> SortEmployees(List<Employees> listOfEmployees) {
            var list = from emp in listOfEmployees
